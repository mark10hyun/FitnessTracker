...
class MainWindow:
    def __init__(self, master):
        ...
        #
        self.deleteBtn = Button(self.frame2, text="Delete", width=15,
                                command=lambda: [self.text.delete(1.0, END), self.text.insert(END,
                                                                                              backend.userDelete(
                                                                                                  self.fname_entry.get(),
                                                                                                  self.lastname_entry.get(), )),
...
class viewAllRecords:
    def __init__(self, master):
        ...
        self.exportCSVBtn = Button(self.frame2, text="Display Records", width=12, bg='skyblue2',
                                   command=lambda: backend.exportCSV)
        self.exportCSVBtn.grid(row=8, column=2, padx=20, pady=20)
